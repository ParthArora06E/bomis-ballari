      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 items-start text-left">
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-4 mt-2">
            ...
            <div class="flex items-start gap-3">
              <svg class="w-5 h-5 text-[#c2410c] mt-0.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            ...
            <div class="flex items-start gap-3">
              <svg class="w-5 h-5 text-[#c2410c] mt-0.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
        ...
        <div class="flex flex-col gap-6">
          ...
          <form id="newsletterForm" class="flex flex-col gap-3">
            ...
            <input type="email" name="email" required placeholder="Your email address" class="w-full px-5 py-3.5 bg-white/50 border border-[#231F20]/10 rounded-2xl focus:outline-none focus:border-[#c2410c] transition-all text-[14px]">
            <button type="submit" class="w-full bg-[#c2410c] text-white font-bold py-3.5 rounded-2xl shadow-lg shadow-[#c2410c]/10 hover:bg-[#c2410c] transition-all text-[14px]">Subscribe</button>
